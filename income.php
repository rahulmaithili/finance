        ...
        <div class="bottom-sheet-body">
            ...
            <form action="income.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon-wrapper">
                        <input type="text" id="m_title" name="title" class="form-control" placeholder="e.g. Monthly Salary" required value="<?= $edit_mode ? clean($edit_income['title']) : '' ?>">
                        <i class="fa-solid fa-file-invoice" style="left:14px;"></i>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon-wrapper">
                        <input type="number" id="m_amount" name="amount" class="form-control" placeholder="0.00" step="0.01" min="0.01" required value="<?= $edit_mode ? clean($edit_income['amount']) : '' ?>"> : '' ?>">
                        <i class="fa-solid fa-indian-rupee-sign" style="left:14px;"></i>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon-wrapper">
                        <input type="date" id="m_income_date" name="income_date" class="form-control" required value="<?= $edit_mode ? clean($edit_income['income_date']) : date('Y-m-d') ?>">
                        <i class="fa-solid fa-calendar-days" style="left:14px;"></i>
                    </div>
                </div>
